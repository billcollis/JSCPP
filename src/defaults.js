(function() {
  ...
  module.exports = function() {
    ...
    this.config.limits["int8_t"] = this.config.limits["signed char"];
    this.config.limits["uint8_t"] = this.config.limits["unsigned char"];
    this.config.limits["avrreg"] = this.config.limits["unsigned char"];
    this.config.limits["avrregbit"] = this.config.limits["unsigned char"];
    ...
    this.config.limits["int16_t"] = this.config.limits["short"];
    this.config.limits["uint16_t"] = this.config.limits["unsigned short"];
    ...
    this.config.limits["long int"] = this.config.limits["long"];
    this.config.limits["int32_t"] = this.config.limits["int"];
    this.config.limits["uint32_t"] = this.config.limits["unsigned"];
    ...
    this.config.limits["int64_t"] = this.config.limits["long long"];
    this.config.limits["uint64_t"] = this.config.limits["unsigned long long"];
    this.config.limits["unsigned long long int"] = this.config.limits["unsigned long long"];
    this.config.limits["single"] = this.config.limits["float"];
    ...
    this.types["(int8_t)"] = defaultOpHandler;
    this.types["(signed char)"] = defaultOpHandler;
    this.types["(uint8_t)"] = defaultOpHandler;
    this.types["(avrreg)"] = defaultOpHandler;
    this.types["(avrregbit)"] = defaultOpHandler;
    ...
    this.types["(int16_t)"] = defaultOpHandler;
    ...
    this.types["(uint16_t)"] = defaultOpHandler;
    ...
    this.types["pointer_function"] = {
      "o(())": {
        "#default": function(rt, l, bindThis, args) {
          ...
          return rt.getCompatibleFunc(l.v.defineType, l.v.name, args).apply(null, [rt, bindThis].concat(__slice.call(args)));
        }
      }
    };
